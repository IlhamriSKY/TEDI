 ...
 *
 *   tsx scripts/ext-schema-verify.ts            # verify the committed file
 *   tsx scripts/ext-schema-verify.ts --write    # regenerate it
 *
...
check(
  ...
  committed === generated,
  committed ? "run: tsx scripts/ext-schema-verify.ts --write" : "file missing; run with --write",
);
