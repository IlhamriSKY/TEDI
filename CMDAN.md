...
**CMDAN** — AI-native terminal emulator, fork of [crynta/terax-ai](https://github.com/crynta/terax-ai). Tauri 2 + Rust (`portable-pty`) backend, React 19 + TypeScript + xterm.js (webgl) client, BYOK AI via Vercel AI SDK v6.
