...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        // No outline, like the buttons it holds: bg-muted already draws the edge.
        "bg-muted flex items-center gap-2 rounded-4xl px-2.5 text-sm font-medium [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
